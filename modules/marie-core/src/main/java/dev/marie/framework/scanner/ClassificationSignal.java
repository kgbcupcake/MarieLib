...
/**
 * Represents a single signal that contributed to source classification.
 ...
 * @param contributions Map of value key to score delta contributed by this signal
 */
@ApiStatus.Internal
public record ClassificationSignal(
    ...
    public static final String TYPE_SOURCE_PROPERTIES = "SOURCE_PROPERTIES";
