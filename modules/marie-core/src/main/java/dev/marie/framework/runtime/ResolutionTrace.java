...
public record ResolutionTrace(
        ...
        Map<String, Float> resolverValues,
        ...
        Map<String, ValueBlend.Precedence> blendPrecedence,
    ...
    public ResolutionTrace {
        ...
        resolverValues = sortedCopy(resolverValues);
    ...
    public String format() {
        ...
        sb.append("Values:\n");
        appendMapIndented(sb, resolverValues);
        ...
        for (Map.Entry<String, ValueBlend.Precedence> e : blendPrecedence.entrySet()) {
