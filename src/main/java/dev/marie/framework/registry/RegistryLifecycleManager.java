...
/**
 * Centralizes the reset → load → validate → freeze lifecycle for MarieLib's static registries.
 *
 ...
 *
 * <p>Registration happens once at consuming mod construction. Subsequent
